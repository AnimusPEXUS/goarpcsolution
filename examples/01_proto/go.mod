...
require (
	github.com/AnimusPEXUS/goinmemfile v0.0.0-20230402102658-16fda24ef49a // indirect
	github.com/AnimusPEXUS/gojsonrpc2 v0.0.0-20230419224628-b099e0ddf71e // indirect
